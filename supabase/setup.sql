...
-- ## Migration: 0021_retention_cleanup.sql

-- 0021: Automatische Aufräumung gegen unbegrenztes Tabellen-Wachstum.
--
...
-- ## Migration: 0029_wipe_keeps_presets.sql
...
-- ## Migration: 0030_admin_list_user_emails.sql
...
-- ## Migration: 0034_account_groups.sql

-- Eigene Konten-Gruppen für Custom-Summen (pro Nutzer privat).
